...
function draw() {
  ...
  fill('white');
  text(
   // 'Match the item with the correct bin. The bins are labeled in red(c = compost)(l = lanfill)(r = recycle)There are 9 items. if you get one wrong game over  At the game over screen  press any key to', 60, 375
  );
  if (cooldown>0){
    cooldown--
    if (cooldown==0){
